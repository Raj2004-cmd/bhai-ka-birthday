...
const messages = [
  "Happy Birthday Madam Jiiii",
  "It's Your Special Day Yeyey! Hope you LOVE this",
  "I didn't know what gift to give. So, i made one. I had to make something special for you cause you are special to me!",
...
const BirthdayGreeting = () => {
  ...
  useEffect(() => {
    if (currentMessageIndex < messages.length) {
      ...
      }, 5000); // Display each message for 7 seconds
